...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          <Route exact path='/patients' element={ <PatientList userData={users} currentUser={currentUser} setCurrentUser={setCurrentUser}/> }></Route>
          <Route exact path='/patients/:patientName' element={ <Patient currentUser={currentUser}/> }></Route>
        </Routes>
      </BrowserRouter>
    </div>
  );
